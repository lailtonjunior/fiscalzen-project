...
- [`setAuthToken`](apps\web\lib\api.ts#L39) (function)
- [`getAuthToken`](apps\web\lib\api.ts#L43) (function)
- [`encryptToBuffer`](apps\api\src\utils\encryption.ts#L36) (function)
- [`decryptFromBuffer`](apps\api\src\utils\encryption.ts#L47) (function)
- [`encryptToBase64`](apps\api\src\utils\encryption.ts#L63) (function)
- [`decryptFromBase64`](apps\api\src\utils\encryption.ts#L67) (function)
- [`authPlugin`](apps\api\src\plugins\auth.ts#L49) (function)
- [`generateToken`](apps\api\src\plugins\auth.ts#L88) (function)
- [`testDbPassword`](tools\apply-postgres-docker-fix.mjs#L112) (function)
- [`forceSetRolePassword`](tools\apply-postgres-docker-fix.mjs#L135) (function)
- [`patchAuth`](tools\apply-auth-manifestacao-fix.mjs#L41) (function)

...
- [`useNfseConfigs`](apps\web\lib\hooks\use-nfse.ts#L24) (function)
- [`useNfseConfig`](apps\web\lib\hooks\use-nfse.ts#L35) (function)
- [`useMunicipios`](apps\web\lib\hooks\use-nfse.ts#L48) (function)
- [`useMunicipio`](apps\web\lib\hooks\use-nfse.ts#L59) (function)
- [`useCreateNfseConfig`](apps\web\lib\hooks\use-nfse.ts#L74) (function)
- [`useUpdateNfseConfig`](apps\web\lib\hooks\use-nfse.ts#L99) (function)
- [`useDeleteNfseConfig`](apps\web\lib\hooks\use-nfse.ts#L126) (function)
- [`useToggleNfseConfig`](apps\web\lib\hooks\use-nfse.ts#L147) (function)
- [`useTestNfseConnection`](apps\web\lib\hooks\use-nfse.ts#L174) (function)
- [`useTriggerNfseSync`](apps\web\lib\hooks\use-nfse.ts#L191) (function)
- [`usePendingManifestations`](apps\web\lib\hooks\use-manifestacao.ts#L33) (function)
- [`usePendingCiencia`](apps\web\lib\hooks\use-manifestacao.ts#L46) (function)
- [`useAwaitingFinal`](apps\web\lib\hooks\use-manifestacao.ts#L59) (function)
- [`useManifestacaoHistory`](apps\web\lib\hooks\use-manifestacao.ts#L72) (function)
- [`usePendingCount`](apps\web\lib\hooks\use-manifestacao.ts#L87) (function)

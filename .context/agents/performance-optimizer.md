...
- [`generateCacheKey`](packages\sefaz-client\src\certificate.ts#L52) (function)
- [`loadCertificadoCached`](packages\sefaz-client\src\certificate.ts#L135) (function)
- [`clearCertificadoCache`](packages\sefaz-client\src\certificate.ts#L154) (function)
- [`useManifestarBatch`](apps\web\lib\hooks\use-manifestacao.ts#L149) (function)
- [`useBatchCiencia`](apps\web\lib\hooks\use-manifestacao.ts#L176) (function)
- [`batchIndexDocuments`](apps\api\src\jobs\search-sync.ts#L111) (function)
- [`getQueueStatus`](apps\api\src\jobs\queues.ts#L153) (function)
- [`getAllQueuesStatus`](apps\api\src\jobs\queues.ts#L173) (function)
- [`closeQueues`](apps\api\src\jobs\queues.ts#L186) (function)
- [`ensureQueue`](apps\api\src\jobs\events.ts#L37) (function)
- [`patchQueues`](tools\apply-bullmq-redis-fix.mjs#L71) (function)
- [`patchQueuesTs`](tools\apply-bullmq-redis-fix-v2.mjs#L59) (function)

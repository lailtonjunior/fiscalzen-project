...
- [`ParsedDocumentBase`](packages\xml-parser\src\types.ts#L56) (interface)
- [`DocumentItem`](packages\xml-parser\src\types.ts#L78) (interface)
- [`ResNFeData`](packages\xml-parser\src\types.ts#L94) (interface)
- [`ResEventoData`](packages\xml-parser\src\types.ts#L114) (interface)
- [`ProcEventoNFeData`](packages\xml-parser\src\types.ts#L132) (interface)

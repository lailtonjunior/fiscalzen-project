...
# FiscalZen - Configurar Testes de Integração com PostgreSQL Plan

> Configurar ambiente de testes de integração com banco PostgreSQL real para validar queries Drizzle, substituindo mocks por testes contra banco isolado usando Docker

...
- **Total symbols discovered:** 905
- **Architecture layers:** Config, Repositories, Controllers, Utils, Services, Models, Components
- **Entry points:** packages\xml-parser\src\index.ts, packages\ui\src\index.ts, packages\shared\src\index.ts (+26 more)
...
- `SefazClient` — C:\fiscalzen-project\packages\sefaz-client\src\client.ts:4

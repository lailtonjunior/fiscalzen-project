...
## Codebase Context
- **Total files analyzed:** 343
- **Total symbols discovered:** 1081
- **Architecture layers:** Config, Generators, Repositories, Controllers, Utils, Services, Models, Components
- **Detected patterns:** Service Layer
- **Entry points:** rag-v1\src\index.ts, packages\xml-parser\src\index.ts, packages\ui\src\index.ts (+36 more)

### Key Components
**Core Classes:**
- `SefazError` — C:\fiscalzen-project\packages\sefaz-client\src\types.ts:194
- `CertificadoError` — C:\fiscalzen-project\packages\sefaz-client\src\types.ts:206
- `TimeoutError` — C:\fiscalzen-project\packages\sefaz-client\src\types.ts:213
- `SoapClient` — C:\fiscalzen-project\packages\sefaz-client\src\soap-client.ts:28
- `SefazClient` — C:\fiscalzen-project\packages\sefaz-client\src\client.ts:16

**Key Interfaces:**
- `ParsedDocumentBase` — C:\fiscalzen-project\packages\xml-parser\src\types.ts:56
- `DocumentItem` — C:\fiscalzen-project\packages\xml-parser\src\types.ts:78
- `ResNFeData` — C:\fiscalzen-project\packages\xml-parser\src\types.ts:94
- `ResEventoData` — C:\fiscalzen-project\packages\xml-parser\src\types.ts:114
- `ProcEventoNFeData` — C:\fiscalzen-project\packages\xml-parser\src\types.ts:132
## Agent Lineup
